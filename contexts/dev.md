...
2. **Plan** — 非自明な変更は必ず `tasks/todo.md` または task-specific な `tasks/<slug>-todo.md` に計画を書き、ユーザ承認を得てから着手する。手順は `plan-mode` skill。仕様自体が無い場合は先に `spec-interview` skill で `docs/spec.md` を確定させる
