...
# .claude and .codex harnesses (ADR 0005 §Decision: each harness keeps its own
# copy of these scripts for standalone readability, rather than sharing a
# single file — but that only stays safe if the copies never diverge).
#
