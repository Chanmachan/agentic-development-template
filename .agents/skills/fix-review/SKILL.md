---
name: fix-review
description: Use when responding to PR review comments. Gathers review comments, decides which need code changes, implements scoped fixes, verifies them, and summarizes the response.
---
