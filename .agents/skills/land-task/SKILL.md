---
name: land-task
description: Use after the user approves merge, to perform the mechanical landing of a task — verify CI green, squash-merge the PR, mark tasks.jsonl done, archive the todo to done/, and prune. Merge approval stays a human gate; never run before it.
---
